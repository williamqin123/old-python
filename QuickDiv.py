...
tk_ttk.wm_title("Division Math DJ! (1-12)")
...
def run_game():
	...
	if rand_operand_1 % rand_operand_2 == 0:
		pass
	else:
		run_game()
	...
	opr = tkinter.ttk.Label(tk_ttk, text = str(rand_operand_1) + "/" + str(rand_operand_2), font = "Arial 28 bold")

	go_to_next = tkinter.ttk.Button(text = "Next", command = deehe)
	
	sty.configure("TButton", font = "Arial 16 bold", width = 12, background = "#019")
